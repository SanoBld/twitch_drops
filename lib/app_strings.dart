...
class AppStrings {
  ...
  static const Map<String, String> _en = {
    ...
    'confirm': 'Confirm',
    'sort_priority_only': 'Priority order only',
    ...
    'notify_email': 'Notify by email on drop claimed',
    'notify_email_sub': 'Opens a pre-filled draft in your default mail app',
    'notify_email_address': 'Recipient email address',
    'quit_app': 'Quit application',
    'quit_confirm_title': 'Quit?',
    'quit_confirm_body': 'This will fully close the app and stop mining, regardless of the tray icon.',
  ...
  static const Map<String, String> _fr = {
    ...
    'confirm': 'Confirmer',
    'sort_priority_only': "Ordre de priorité uniquement",
    ...
    'notifications': 'Notifications',
    'notify_email': 'Notifier par email quand un drop est récupéré',
    'notify_email_sub': 'Ouvre un brouillon pré-rempli dans ton client mail par défaut',
    'notify_email_address': 'Adresse email destinataire',
    'quit_app': "Quitter l'application",
    'quit_confirm_title': 'Quitter ?',
    'quit_confirm_body': "Ferme complètement l'application et arrête le minage, peu importe l'état de l'icône dans la barre système.",
